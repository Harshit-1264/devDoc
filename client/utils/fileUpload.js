...
export const handleYtLink = async (
  YtLink,
  setYtVideoDetails,
  setShowYtPreview
) => {
  ...
  try {
    ...
    toast.error(error.message || "Failed to fetch YouTube video details.");
...
export const getYouTubeVideoDetails = async (videoId) => {
  ...
  return {
    ...
    channelTitile: video.snippet.channelTitile,
    publishDate: video.snippet.publishDate,
...
// website link handler Start ---------------------------------------------------------------------------------------------------------------------

export const handleWebsiteLink = async (
  websiteLink,
  setCurrentStep,
  setWebsiteProgress
) => {
  ...
  try {
    ...
    // Immediately set progress UI to 5% so the user sees something changed.
...
// YT VIDEO EMBEDDING SECTION ---------------------------------------------------------------------------------------------
export const startEmbeddingYtVideo = async (
  YtLink,
  setUploading,
  setShowYtPreview,
  onYtVideoEmbedded,
